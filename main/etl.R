...
dt2024_cmb <- process_data(dt2024)
...
dt_rank_cmb <- bind_rows(dt2024_rank_cmb, dt2023_rank_cmb, dt2022_rank_cmb, dt2021_rank_cmb, dt2020_rank_cmb)  %>% 
  mutate(school = substr(院校, 5, nchar(院校))) %>% 
  left_join(dplyr::select(
    read_excel("/Users/sousekilyu/Documents/GitHub/GaoKaoVer3/data/全国普通高等学校名单.xlsx"),
